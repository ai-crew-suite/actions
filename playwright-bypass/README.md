# `@ai-crew-suite/actions/playwright-bypass`
...
yarn turbo run lint --filter=@ai-crew-suite/action-playwright-bypass
```
  ...
  e2e-testing:
    ...
    steps:
      ...
      - name: 🚀 Run Playwright End-to-End Tests
        ...
        uses: ai-crew-suite/actions/ci@v1

      - name: 🪵 Generate Visual E2E Skip Summary
        if: ${{ startsWith(github.head_ref, 'hotfix/') }}
        uses: ai-crew-suite/actions/playwright-bypass@v1
```

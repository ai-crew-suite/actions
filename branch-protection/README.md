# `@ai-crew-suite/actions/branch-protection`
...
yarn turbo run lint --filter=@ai-crew-suite/action-branch-protection
```
  ...
  validate:
    ...
    steps:
      - name: 🏷️ Run Centralized Protection Gate
        uses: ai-crew-suite/actions/branch-protection@v1
        with:
